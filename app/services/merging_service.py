        ...
        try:
            ...
            if audio_data and audio_data.get('subtitles'):
                try:
                    ...
                    logger.warning(f"Failed to embed subtitles, continuing without them: {subtitle_error}")
            ...
            if result.returncode != 0:
                ...
                if result.returncode != 0:
                    ...
                    if subtitle_text:
                        ...
                        if result.returncode != 0:
                            raise Exception(f"All subtitle embedding methods failed: {result.stderr}")
                    else:
